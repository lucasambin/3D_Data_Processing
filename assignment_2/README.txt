...
./bin/matcher datasets/3dp_cam.yml datasets/images_1 data1.txt 1.1
./bin/matcher datasets/3dp_cam.yml datasets/images_2 data2.txt 1.1
./bin/matcher datasets/my_calib.yaml datasets/images_3 data3.txt 1.2

./bin/basic_sfm datasets/test_data1.txt cloud1.ply
./bin/basic_sfm datasets/test_data2.txt cloud2.ply
./bin/basic_sfm data1.txt my_cloud1.ply
./bin/basic_sfm data2.txt my_cloud2.ply
./bin/basic_sfm data3.txt my_cloud3.ply